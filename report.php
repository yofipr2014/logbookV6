...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
        <td>
            <form name="art_form" id="art_form" method="post" action="report.php" style="margin: 0px; padding: 0px;">
...
<div id="sitemenu_report_th"><br /><table border="0" cellspacing="0" cellpadding="0"  width="150px">
    ...
    <tr>
        ...
        <td valign="middle" class="siteMenuBody">
             <div class="siteMenu">
             <ul>
                 <li><a href="./logbook.php?clr_logbook=t&clr_logbook_adv_session=y" title="logbook">logbook</a></li>
...
$ambildata=mysql_query("SELECT 
  pelayanan.nm_pelayanan AS PELAYANAN,
  COUNT(logbook.id) AS JUMLAH
FROM
  logbook
  RIGHT OUTER JOIN pelayanan ON (logbook.id_pel = pelayanan.id_pel)
WHERE TGL LIKE '$tgl%' and uid='$uid' 
GROUP BY
