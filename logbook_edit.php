...
require_once './logbook_edit_func.php';
require_once "./user_login_func.php";
art_check_permission(1, "./logbook_edit.php");


art_setdefault_session('art_form_loaded', 0);
$cssfile = "./css/logbook_edit_th.css";
$cssname = "logbook_edit_th";
$header_text = "";
...
<link href="./css/logbook_edit_th.css" rel="stylesheet" type="text/css">
...
?>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
            <td>
                <form name="art_form" id="art_form" method="post" action="logbook_edit.php"  style="margin: 0px; padding: 0px;">
