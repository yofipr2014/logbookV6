...
require_once './Add_User_func.php';
require_once "./user_login_func.php";
art_check_permission(1, "./Add_User.php");
...
?>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
            <td>
                <form name="art_form" id="art_form" method="post" action="Add_User.php"  style="margin: 0px; padding: 0px;">
