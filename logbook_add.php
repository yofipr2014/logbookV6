...
require_once './logbook_add_func.php';
require_once "./user_login_func.php";
art_check_permission(1, "./logbook_add.php");


art_setdefault_session('art_form_loaded', 0);
$cssfile = "./css/logbook_add_th.css";
$cssname = "logbook_add_th";
$style = "logbook_add_th";
$header_text = "";
...
<link href="./css/logbook_add_th.css" rel="stylesheet" type="text/css">
...
?>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
            <td>
                <form name="art_form" id="art_form" method="post" action="logbook_add.php"  style="margin: 0px; padding: 0px;">
